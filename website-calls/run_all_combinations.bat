...
set EXT_TOR=extensions\firefox-xpi\ublock_origin-1.66.4.xpi extensions\firefox-xpi\privacy-badger-latest.xpi extensions\firefox-xpi\canvasblocker-1.11.xpi
